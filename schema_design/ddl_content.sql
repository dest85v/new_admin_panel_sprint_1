...
CREATE UNIQUE INDEX IF NOT EXISTS genre_film_work_genre_idx ON content.genre_film_work(film_work_id, genre_id);
CREATE UNIQUE INDEX IF NOT EXISTS persons_film_work_person_idx ON content.person_film_work(film_work_id, person_id, role);
